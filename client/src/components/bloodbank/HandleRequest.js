...
const HandleRequest = () => {
  ...
  useEffect(() => {
    Axios.get("https://cic6163ew5.execute-api.ap-northeast-2.amazonaws.com/test/login/emp/hr").then((response) => {
      if (response) {
...
const delUrl = "https://cic6163ew5.execute-api.ap-northeast-2.amazonaws.com/test/login/emp/hr/"+req_id;
